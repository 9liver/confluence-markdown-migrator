...
from converters.macro_converter import MacroConverter
...
# Apply macro conversion
macro_converter = MacroConverter()
html_content = macro_converter.convert(html_content)

print("=== STEP 3: After MacroConverter ===")
print(html_content)
print()
...
print("=== STEP 4: After HtmlListFixer ===")
print(html_content)
print()
...
print("=== STEP 5: Final Markdown ===")
print(markdown)
print()

print("=== STEP 6: Show raw markdown (repr) ===")
print(repr(markdown))